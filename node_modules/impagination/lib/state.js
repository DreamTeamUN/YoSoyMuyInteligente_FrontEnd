...
var State = (function () {
  ...
  _createClass(State, [{
    ...
    value: function setReadOffset(readOffset) {
      return new State(this, { readOffset: readOffset });
    }
  }, {
    key: 'fetch',
    value: function fetch() {
      ...
      return new State(this, { _pages: _pages });
    }
  }, {
    key: 'unfetch',
    ...
    value: function refilter(filter) {
      var _this = filter ? new State(this, { filter: filter }) : this;
      ...
      return new State(_this, { _pages: _pages });
    }
